 ...
 * 2015-09-15       荣杰         1.1
 *
 * com.zxq.iov.cloud.sp.vp.entity.event.StepDefinition
 *
 * sp - sp-vp-model
 */
...
public class StepDefinition extends MyBaseEntity<Long> implements Serializable {
	...
	public StepDefinition(Long taskDefinitionId, String name, Integer lifecycle, Long preStepDefinitionId,
			Integer retryLimit, String startCode, Boolean isRollback, Boolean isLast, Integer sort) {
