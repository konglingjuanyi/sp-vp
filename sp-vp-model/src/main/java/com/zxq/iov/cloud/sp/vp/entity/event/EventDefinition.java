 ...
 * 2015-06-04       荣杰         1.1
 *
 * com.zxq.iov.cloud.sp.vp.entity.event.EventDefinition
 *
 * sp - sp-vp-model
 */
...
public class EventDefinition extends MyBaseEntity<Long> implements Serializable {
	...
	public EventDefinition(String name, Integer type, Integer lifecycle, Boolean isExclusive, Boolean isContinue,
			Boolean isRollback) {
		this.name = name;
		this.type = type;
