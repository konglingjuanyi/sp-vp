 ...
 * 安防服务 任务定义类
 * @author 叶荣杰
 * create time 2015-6-2 17:31
 * modify time 2015-6-4
...
public class TaskDefinition extends MyBaseEntity<Long> implements Serializable {
    ...
    public TaskDefinition(Long eventDefinitionId, String name, Integer lifecycle, Long preTaskDefinitionId, Integer cycleLimit, Boolean isExclusive, Boolean isContinue, Boolean isRollback, Boolean isLast, Integer sort) {
