 ...
 */
@Service
public class VehiclePosDaoServiceImpl extends BaseServiceImpl<IVehiclePosRepository, VehiclePos, Long> implements IVehiclePosDaoService {

	private static final Logger LOGGER = LoggerFactory.getLogger(VehiclePosDaoServiceImpl.class);

    @Autowired
	public VehiclePosDaoServiceImpl(IVehiclePosRepository repo){
		super(repo);
	}
