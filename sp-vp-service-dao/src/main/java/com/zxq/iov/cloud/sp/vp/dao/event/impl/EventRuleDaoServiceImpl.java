 ...
 */
@Service
public class EventRuleDaoServiceImpl extends BaseServiceImpl<IEventRuleRepository, EventRule, Long> implements IEventRuleDaoService {

	private static final Logger LOGGER = LoggerFactory.getLogger(EventRuleDaoServiceImpl.class);

    @Autowired
	public EventRuleDaoServiceImpl(IEventRuleRepository repo){
		super(repo);
	}
