 ...
 */
@Service
public class TboxConfigSettingDaoServiceImpl extends BaseServiceImpl<ITboxConfigSettingRepository, TboxConfigSetting, Long> implements ITboxConfigSettingDaoService {

	private static final Logger LOGGER = LoggerFactory.getLogger(TboxConfigSettingDaoServiceImpl.class);

    @Autowired
	public TboxConfigSettingDaoServiceImpl(ITboxConfigSettingRepository repo){
		super(repo);
	}
