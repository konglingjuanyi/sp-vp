 ...
 */
@Service
public class DiagnosticDaoServiceImpl extends BaseServiceImpl<IDiagnosticRepository, Diagnostic, Long> implements IDiagnosticDaoService {

	private static final Logger LOGGER = LoggerFactory.getLogger(DiagnosticDaoServiceImpl.class);

    @Autowired
	public DiagnosticDaoServiceImpl(IDiagnosticRepository repo){
		super(repo);
	}
