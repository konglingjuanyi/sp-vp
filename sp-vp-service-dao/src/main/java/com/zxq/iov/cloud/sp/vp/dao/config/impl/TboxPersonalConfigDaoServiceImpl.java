 ...
 */
@Service
public class TboxPersonalConfigDaoServiceImpl extends BaseServiceImpl<ITboxPersonalConfigRepository, TboxPersonalConfig, Long> implements ITboxPersonalConfigDaoService {

	private static final Logger LOGGER = LoggerFactory.getLogger(TboxPersonalConfigDaoServiceImpl.class);

    @Autowired
	public TboxPersonalConfigDaoServiceImpl(ITboxPersonalConfigRepository repo){
		super(repo);
	}
